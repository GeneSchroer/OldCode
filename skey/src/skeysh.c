...
#ifndef HAVE_VARIABLE_ENVIRON
extern char **environ;
#endif
#ifndef HAVE_FUNCTION_SETENV

#endif
#ifndef HAVE_FUNCTION_GETENV
...
int *skey_haskey(), skey_authenticate();
